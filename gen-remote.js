...
var genPath      =  path.join(__dirname, 'files');
 ...
 * Expected to be called during initialization and therefore uses sync IO
 *  TODO: make async and take array of configs to generate remotes for
 *        call back with list of paths of remotes 
 *
 * @name genRemote
 * @function
 * @param {Object} config  { 
